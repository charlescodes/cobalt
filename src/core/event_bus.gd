...
signal gameplay_control_mode_changed(mode: StringName)
signal gameplay_control_mode_requested(mode: StringName)
signal active_player_character_changed(actor: Node, actor_data: Resource)
...
signal editor_world_geology_parameters_changed(parameters: Dictionary)
